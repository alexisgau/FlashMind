...
import com.example.flashmind.data.local.dao.*
import com.example.flashmind.data.local.entities.*
...
import kotlinx.coroutines.tasks.await
    ...
    class RestoreUserDataWorker @AssistedInject constructor(
        ...
        override suspend fun doWork(): Result {
            ...
            Log.i("RestoreWorker", "Iniciando restauración para: $userId")
            ...
            return try {
                ...
                if (categories.isNotEmpty()) {
                    ...
                    Log.i("RestoreWorker", "Categorías insertadas: ${categories.size}")
                } else {
                    Log.w("RestoreWorker", "No se encontraron categorías. Deteniendo restauración.")
                ...
                if (lessons.isNotEmpty()) {
                    ...
                    Log.i("RestoreWorker", "Lecciones insertadas: ${lessons.size}")
                }
                ...
                Log.i("RestoreWorker", "Restauración completada con éxito.")
                Result.success()
